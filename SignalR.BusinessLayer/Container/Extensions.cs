...
namespace SignalR.BusinessLayer.Container
{
    public static class Extensions
    {
        ...
        {
            // birbirinden kalıtım almış sınıfları çağırıyoruz. REGISTERAZTION
            services.AddScoped<IAboutService, AboutManager>();// Scope olarak ekliyoruz IAboutService görünce AboutManager sınıfını çağır.
