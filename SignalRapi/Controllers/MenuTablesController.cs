...
namespace SignalRapi.Controllers
{
    ...
    public class MenuTablesController : ControllerBase
    {
        ...
        public IActionResult CreateMenuTable(CreateMenuTableDto createMenuTableDto)
        {
            ...
            var value=_mapper.Map<MenuTable>(createMenuTableDto); // createAboutDto'yu about'a dönüştürüyoruz
        ...
        public IActionResult ChangeMenuTableStatusToTrue(int id)
        {
            ...
            return Ok("Masa alanı aktif edildi");
        }
        ...
        public IActionResult ChangeMenuTableStatusToFalse(int id)
        {
            ...
            return Ok("Masa alanı deaktif edildi");
        }
